...
const std::vector<Node*>& Graf::GetVectorOfNodes()const
{
    return m_nodes;
}
...
void Graf::Read()
{
    ...
    QFile f("C:/Users/Nechita Bianca/Desktop/TemaLux/Tema5/Luxembourg/hartaLuxembourg.xml");
    ...
    while (!Component.isNull())
    {
        if (Component.tagName() == "nodes")
        {
            ...
            while (!Child.isNull())
            {
                //std::cout << Chiltxtd.tagName().toStdString()<<"\n";
